# Jupyter notebook over Apache Iceberg and AWS_Glue
...
### Add following policies to the role for sample porpouse
...
## User defined must enable to sts:AssumeRole the AWS_ROLE
```
{
    "Version": "2012-10-17",
    "Statement": [
